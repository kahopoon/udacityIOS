...
let stringToReverse = String("Mutable or Immutable? That is the question.".characters.reversed())
/*: 
### Exercise 4
...
var winRequiredScore:Int
var studentBirthdayYYYYMMDD:String
var statusUpdateMessageFromUser:String
