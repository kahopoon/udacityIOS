 ...
 */
func beginsWithVowel(_ input: String) -> Bool {
    return input.characters.count > 0 ? (["a", "e", "i", "o", "u"].map{ $0 == input.lowercased().characters.first }.contains(true)) : false
}
...
func funWithWords(_ input: String) -> String {
    return beginsWithVowel(input) ? input.uppercased() : input.lowercased()
}
